...
app.config(["$routeProvider","$locationProvider","$httpProvider",function($routeProvider,$locationProvider) {
    ...
    .when("/MemberGet",{
        templateUrl : "views/pages/Member/MemberGet.html",
        controller: 'memberGet'
    })
    
    .when("/MemberAdd",{
        templateUrl : "views/pages/Member/MemberAdd.html",
        controller: 'MemberAdd'
    })

    .when("/Member/Login",{
        templateUrl : "views/pages/Member/Login.html",
        controller: 'Login'
    })
